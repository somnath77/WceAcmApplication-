...
// Inflate the layout for this fragment
    ...
    public void  onViewCreated(View view,Bundle savedInstanceState){
        ...
        this.v=view;
        mBlogList = (RecyclerView) view.findViewById(R.id.RecycleView_second);
        ...
        FirebaseRecyclerAdapter<people, SecondFragment.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<people, SecondFragment.BlogViewHolder>
                (people.class, R.layout.card_member, SecondFragment.BlogViewHolder.class, mdatabase) {
            @Override
            protected void populateViewHolder(SecondFragment.BlogViewHolder blogViewHolder, people ppl, int i) {
