...
// Inflate the layout for this fragment
    ...
    public void  onViewCreated(View view,Bundle savedInstanceState){
        ...
        this.v=view;
        mBlogList = (RecyclerView) view.findViewById(R.id.RecycleView_third);
        mBlogList.setHasFixedSize(true);
        mBlogList.setLayoutManager(new LinearLayoutManager(getActivity()));

        mdatabase= FirebaseDatabase.getInstance().getReference().child("MemberBoard");
        mdatabase.keepSynced(true);

        FirebaseRecyclerAdapter<people, ThirdFragment.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<people, ThirdFragment.BlogViewHolder>
                (people.class, R.layout.card_member, ThirdFragment.BlogViewHolder.class, mdatabase) {
            @Override
            protected void populateViewHolder(ThirdFragment.BlogViewHolder blogViewHolder, people ppl, int i) {
